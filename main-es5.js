...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 70,
      vars: 0,
      consts: [["type", "radio", "id", "confusion-no", "name", "confusion", "checked", "true", "onchange", "Sub()"], ["type", "radio", "id", "confusion-yes", "name", "confusion", "onchange", "Add()"], ["type", "radio", "id", "bun-no", "name", "bun", "checked", "true", "onchange", "Sub()"], ["type", "radio", "id", "bun-yes", "name", "bun", "onchange", "Add()"], ["type", "radio", "id", "respiratory_rate-no", "name", "respiratory_rate", "checked", "true", "onchange", "Sub()"], ["type", "radio", "id", "respiratory_rate-yes", "name", "respiratory_rate", "onchange", "Add()"], ["type", "radio", "id", "systolic_diastolic_bp-no", "name", "systolic_diastolic_bp", "checked", "true", "onchange", "Sub()"], ["type", "radio", "id", "systolic_diastolic_bp-yes", "name", "systolic_diastolic_bp", "onchange", "Add()"], ["type", "radio", "id", "age-no", "name", "age", "checked", "true", "onchange", "Sub()"], ["type", "radio", "id", "age-yes", "name", "age", "onchange", "Add()"], ["type", "button", "onclick", "location.reload();"], ["id", "Result"], ["id", "results"], ["id", "Mortality"], ["id", "Treatment"], [2, "list-style-type", "none"]],
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /home/bluexen0n/CURB/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
